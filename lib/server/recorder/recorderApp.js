...
class RecorderApp extends _events.EventEmitter {
  constructor(recorder, page, wsEndpoint, inspectedContext) {
    super();
    this._page = void 0;
    this.wsEndpointForTest = void 0;
    this._recorder = void 0;
    this._inspectedContext = void 0;
  ...
  async setSelector(selector, userGesture) {
    if (userGesture) {
      var _this$_inspectedConte, _this$_recorder;
      (_this$_inspectedConte = this._inspectedContext) === null || _this$_inspectedConte === void 0 || _this$_inspectedConte.emit(_browserContext.BrowserContext.Events.OnAction, {
        action: {
          name: 'inspecting',
          selector: selector
        }
